...
class ai_cpu:
     ...
     decision_move
     decision_side
     decision_attack_side
     weights

     def __init__(self):
        self.ai_player = Player()

     def calculate_move(self, user_left, user_right, cpu_left, cpu_right):
        # it needs 4 input values: fingers its left and right hands, and fingers on opponent's hands
        cpu_left

    def generate_first_pop():
        for x in range(3)
